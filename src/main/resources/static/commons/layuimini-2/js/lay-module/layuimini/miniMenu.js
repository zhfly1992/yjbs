    ...
    var miniMenu = {
        ...
        renderMultiModule: function (menuList, menuChildOpen) {
            ...
            $.each(menuList, function (key, val) {
                ...
                $.each(menuList, function (index, menu) {
                    leftMenuHtml += '<li class="layui-nav-item '+((menuChildOpen == false && menu.isopen == true) ? 'layui-nav-itemed' : '')+' ' + childOpenClass + '">\n';
        ...
        listen: function () {
            ...
            $('body').on('click', '[data-side-fold],.layuimini-site-mobile', function () {
                ...
                if (isShow == 1) { // 缩放
                    ...
                    //$('.layui-footer').css('left', '200px');// 页脚
                }
                element.init();
                layer.close(loading);
            });
